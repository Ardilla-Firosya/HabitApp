...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvPriority : ImageView = itemView.findViewById<ImageView>(R.id.priority_level)
        val tvStartTime = itemView.findViewById<TextView>(R.id.tv_start_time)
        val tTvCountTime = itemView.findViewById<TextView>(R.id.tv_minutes)
        val buttonCountDown = itemView.findViewById<TextView>(R.id.btn_open_count_down)

        fun bind(pageType: PageType, pageData: Habit) {

            tvTitle.text = pageData.title
            tvStartTime.text = pageData.startTime
            tTvCountTime.text = pageData.minutesFocus.toString()

            val custom = when (pageType) {
                PageType.HIGH ->
            ...
            tvPriority.setImageResource(custom)
