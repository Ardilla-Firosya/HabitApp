...
class HabitAdapter(
    ...
    override fun onBindViewHolder(holder: HabitViewHolder, position: Int) {
        ...
        val dataHabit = getItem(position) as Habit
        holder.bind(dataHabit)
    }

    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        private val tvTitle: TextView = itemView.findViewById(R.id.item_tv_title)
        val tvPriority: ImageView = itemView.findViewById(R.id.item_priority_level)
        ...
        fun bind(habit: Habit) {
            ...
            val custom = when(habit.priorityLevel.lowercase()){
